...
More important ones:
 ...
 - [WSPT_STORE_PASS]: Manage username and password for web services (eg. 504109197 -> FILIPEMAST625). (Requires RSECACHK entry).
 ...
 - [BF11]: Activate SIPT, SIPTC and SIPT_M.
...
# Tables that need to be changed [SM30]
 ...
 - [WSPT_REJ_CODES] -> Check rejection_codes.md
